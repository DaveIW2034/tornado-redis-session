...
class Session(SessionData):
    ...
    def save(self, timeout_set=None):
        self.session_manager.set(self.request_handler, self, timeout=timeout_set)
...
class SessionManager(object):
    ...
    def _fetch(self, session_id):
        try:
            ...
            if raw_data != None:
                if -1 != self.redis.ttl(session_id) and -2 != self.redis.ttl(session_id):
    ...
    def get(self, request_handler=None):
        ...
        #    hmac_key = None
        # else:
        session_id = request_handler.get_secure_cookie("session_id", None)
        hmac_key = request_handler.get_secure_cookie("verification", None)
